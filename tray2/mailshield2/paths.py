...
def data_dir() -> Path:
    base = os.getenv("MAILSHIELD2_DATA_DIR") or os.getenv("LOCALAPPDATA") or str(Path.home())
    path = Path(base) / "MailShield2"
...
def executable_command() -> str:
    ...
    launcher = Path(__file__).resolve().parent.parent / "MailShield2Tray.pyw"
