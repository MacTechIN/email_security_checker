from mailshield_tray import paths
from mailshield_tray.scanner import ScanResult
from mailshield_tray.store import AUTH_OAUTH, FOLDER_AUTO_SENT, AccountSettings, CheckpointStore, IncidentLog, Settings
...
def test_settings_roundtrip(isolated_data_dir):
    ...
    assert paths.settings_path().parent == isolated_data_dir / "MailShield"
