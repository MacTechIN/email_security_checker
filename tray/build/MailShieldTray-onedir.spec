...
실행: pyinstaller build/MailShieldTray-onedir.spec --distpath dist-onedir (tray/ 에서)
"""

from pathlib import Path

ROOT = Path(SPECPATH).resolve().parent
ICON = ROOT / "build" / "MailShieldTray.ico"
RESOURCES = ROOT / "mailshield_tray" / "resources"
